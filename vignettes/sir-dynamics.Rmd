...
plot_infectiousdisease_time(sis_out, model_type = "SIS")
...
plot_infectiousdisease_time(seir_out, model_type = "SEIR")
```
...
plot_infectiousdisease_time(sird_out, model_type = "SIRD")
```
