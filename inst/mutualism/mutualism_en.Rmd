...
The parameter descriptions are listed in the table below. The first term of each dynamics equation ($r_iN_i$) describes population growth in the absence of interactions. The second term  ($\frac{\alpha_{ij}N_j}{b_j + N_j}N_i$) describes how population growth increases as a saturating function of the mutualist's population size (expressed in the form of a [Michaelis–Menten curve](https://en.wikipedia.org/wiki/Michaelis%E2%80%93Menten_kinetics) with a half-saturation constant of $b_i$). Finally, the third term ($d_iN_i^2$) describes how the rate of population growth decreases as the population grows in size.
...
pars <- c("$r_1$",
          ...
          "$d_2$",
          "$b_i$")
descriptions <- c("Per capita growth rate of species 1",
                  "Per capita growth rate of species 2",
                  "Population size of Species 1",
                  "Population size of Species 2",
                  "Per capita mutualistic effect of Species 2 on Species 1",
                  "Per capita mutualistic effect of Species 1 on Species 2",
                  "Rate of self-limitation for Species 1",
                  "Rate of self-limitation for Species 2",
                  "Half-saturation constant of the Michelis-Menten equation, i.e. the population size of species $i$ at which it provides half its maximum benefit to species $j$")
