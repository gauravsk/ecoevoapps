...
***[中文](https://ecoevoapps.shinyapps.io/single_pop_discrete_ch/) | Español | [English](https://ecoevoapps.shinyapps.io/single_pop_discrete/) ***
...
plot_caption_exp <- reactive({
    latex2exp::TeX(paste0("Valores del parámetro:: $\\lambda = $", input$lambda))
})
...
App maintained by Gaurav Kandlikar (gaurav.kandlikar@gmail.com) & Alejandra Martínez Blancas()
