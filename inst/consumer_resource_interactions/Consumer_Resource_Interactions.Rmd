...
np_lvpred1 <- reactive({vector_field(out_lv_pred1(), vec_input_lv_pred1()) +
...
np_logprey <- reactive({vector_field(out_logprey(), vec_input_logprey()) +
...
np_lvpred2 <- reactive({vector_field(out_lv_pred2(), vec_input_lv_pred2()) +
...
np_rm <- reactive({vector_field(out_rm(), vec_input_rm()) +
