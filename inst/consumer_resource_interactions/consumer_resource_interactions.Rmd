...
np_lvpred1 <- reactive({
  if("Yes" %in% input$vectors_lv_pred1) {
    plot_predprey_trajectory(out_lv_pred1(), pars_lv_pred1(), 
                                         vectors_field = TRUE)
  } else {
    plot_predprey_trajectory(out_lv_pred1(), pars_lv_pred1(), 
                             vectors_field = F)
...
np_logprey <- reactive({
  if("Yes" %in% input$vectors_logprey) {
    plot_predprey_trajectory(out_logprey(), pars_logprey(), 
                                         vectors_field = TRUE)
  } else {
    plot_predprey_trajectory(out_logprey(), pars_logprey(), 
                             vectors_field = FALSE)
...
np_lvpred2 <- reactive({
  if("Yes" %in% input$vectors_lv_pred2) {
    plot_predprey_trajectory(out_lv_pred2(), pars_lv_pred2(), 
                                         vectors_field = TRUE)
  } else {
    plot_predprey_trajectory(out_lv_pred2(), pars_lv_pred2(), 
                             vectors_field = FALSE)
...
np_rm <- reactive({
  if("Yes" %in% input$vectors_rm) {
    plot_predprey_trajectory(out_rm(), pars_rm(), 
                                         vectors_field = TRUE)
  } else {
    plot_predprey_trajectory(out_rm(), pars_rm(), 
                             vectors_field = FALSE)
