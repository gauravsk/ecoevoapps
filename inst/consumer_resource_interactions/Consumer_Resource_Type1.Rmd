...
np_lvpred1 <- reactive(plot(out_lv_pred1()$H, out_lv_pred1()$P, type='l', xlab="Number of Prey", ylab="Number of Predators"))
...
np_logprey <- reactive(plot(out_logprey()$H, out_logprey()$P, type='l', xlab="Number of Prey", ylab="Number of Predators"))
