...
sidebarLayout(
  ...
  # Render plots -----------------
  mainPanel(renderPlot({abund_plot_SIR()}, width = 600, height = 500))
...
sidebarLayout(
  ...
  # Render plots -----------------
  mainPanel(renderPlot({plots_to_render_SIR_sir_novitals()}, width = 600, height = 500))
...
sidebarLayout(
  ...
  # Render plots -----------------
  mainPanel(renderPlot({abund_plot_sis()}, width = 600, height = 500))
...
sidebarLayout(
  ...
  # Render plots -----------------
  mainPanel(renderPlot({abund_plot_seir()}, width = 600, height = 500))
...
sidebarLayout(
  ...
  # Render plots -----------------
  mainPanel(renderPlot({abund_plot_sird()}, width = 600, height = 500))
