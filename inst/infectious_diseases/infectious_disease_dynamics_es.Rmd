---
title: "Modelos compartimentales de enfermedades infecciosas"
output: html_document
runtime: shiny
---

***[中文](https://ecoevoapps.shinyapps.io/sir_disease_dynamics_ch/) | Español | [English](https://ecoevoapps.shinyapps.io/sir_disease_dynamics/) | [português](https://ecoevoapps.shinyapps.io/sir_disease_dynamics_pt/) | [Turkish](https://ecoevoapps.shinyapps.io/sir_disease_dynamics_tr/) ***
...
Esta aplicación implementa una categoría de modelos de epidemiología llamados [Modelos Compartimentales](https://en.wikipedia.org/wiki/Compartmental_models_in_epidemiology). Estos modelos están diseñados para modelar el contagio de enfermedades en poblaciones  compuestas de invidiuos en diferentes compartimentos, como por ejemplo individuos que son susceptibles a la enfermedad, individuos expuestos, individuos infectados, individuos recuperados, etc.  Distintos modelos pueden incluir diferentes compartimientos, basados en la población estudiada y las dinámicas de la infección. Para más detalles sobre los modelos compartimentales, por favor referirse a la [página de Wikipedia](https://es.wikipedia.org/wiki/Modelos_compartimentales_en_epidemiolog%C3%ADa) o a [este artículo](https://vtechworks.lib.vt.edu/bitstream/handle/10919/84993/ChildsIntroduction.pdf). 
...
ecoevoapps::print_app_footer("es")
```
