---
title: "Competencia por los recursos abióticos"
output: html_document
runtime: shiny
---
***[中文](https://ecoevoapps.shinyapps.io/abiotic_resource_competition_ch) |  Español | [English](https://ecoevoapps.shinyapps.io/abiotic_resource_competition) | [português](https://ecoevoapps.shinyapps.io/abiotic_resource_competition_pt) | [Turkish](https://ecoevoapps.shinyapps.io/abiotic_resource_competition_tr)  ***
...
pars_vars <- c("$N_i$",
               ...
               "$S_j$",
               "$a_j$")
descriptions <- c("Tamaño de la población de la especie consumidora $i$",
                 "Abundancia del recurso $j$",
                 "Tasa de crecimiento per cápita máximo de la especie consumidora $i$",
                 "Constante de semi-saturación del consumidor $i$ por el recurso $j$ (p. ej., la concentración del recurso $j$ a la cual la especie $i$ crece a la mitad de su tasa de crecimiento máxima)",
                 "Tasa de consumo del recurso $j$ por la especie $i$",
                 "Tasa de mortalidad de la especie consumidora $i$",
                 "Punto de suministro (o nivel máximo) del recurso $j$",
                 "Tasa a la que el recurso $j$ es convertido de su forma inutilizable a utilizable")
...
sidebarLayout(
  sidebarPanel(style = "overflow-y:scroll; max-height: 400px",
    ...
    h5("Tasas de suministro de los recursos"),
    ...
    # User defined resource growth rate -------
    h5("Tasas de crecimiento intrínseco máximo de los consumidores"),
    ...
    h5("Constantes de semi-saturación"),
    ...
    # User defined resource uptake rates -------
    h5("Tasas de consumo de los recursos"),
    ...
    h5("Tasas de conversión de recursos"),
    ...
    h5("Tamaño inicial de la población de los consumidores"),
    column(width = 6, numericInput("N1", label = "N1",
                min = 1, max = 100, value = 10)),
    column(width = 6, numericInput("N2", label = "N2",
                min = 1, max = 100, value = 10)),
    h5("Tamaño inicial de las reservas de recursos"),
    column(width = 6,
    ...
    column(width = 6,
           numericInput("R2", label = "R2",
                min = 1, max = 100, value = 20)),
    # User defined time ---------
    numericInput("time", label = "Número de pasos de tiempo a proyectar",
...
Tilman, D. 1980. [Resources: A graphical-mechanistic approach to competition and predation](https://www.jstor.org/stable/2463311). The American Naturalist.
