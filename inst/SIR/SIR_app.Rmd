...
# Plot S vs I ---------
SIplot <- reactive({
  plot_infectiousdisease_trajectories(sim_df = out(), x_axis = "S", y_axis = "I")
})

# Plot I vs R --------------
RIplot <- reactive({
  plot_infectiousdisease_trajectories(sim_df = out(), x_axis = "R", y_axis = "I")
})

# Plot S vs R ------------
SRplot <- reactive({
  plot_infectiousdisease_trajectories(sim_df = out(), x_axis = "S", y_axis = "R")
})
...
# Plot S vs I
SIplot_sis <- reactive({
  plot_infectiousdisease_trajectories(sim_df = out_sis(), 
                                      x_axis = "S", y_axis = "I")
...
SEplot_seir <- reactive({
  plot_infectiousdisease_trajectories(sim_df = out_seir(), 
                                      x_axis = "S", y_axis = "E")
})
...
SDplot_sird <- reactive({
  plot_infectiousdisease_trajectories(sim_df = out_sird(), 
                                      x_axis = "S", y_axis = "D")  
})
...
# Plot S vs I ---------
SIplot_ft <- reactive({
  plot_infectiousdisease_trajectories(sim_df = out_ft(), 
                                      x_axis = "S", y_axis = "I")  
})
...
SIplot_sis_ft <- reactive({
  plot_infectiousdisease_trajectories(sim_df = out_sis_ft(), 
                                      x_axis = "S", y_axis = "I")  
})
...
SEplot_seir_ft <- reactive({
  plot_infectiousdisease_trajectories(sim_df = out_seir_ft(), 
                                      x_axis = "S", y_axis = "E")  
})
...
SDplot_sird_ft <- reactive({
    plot_infectiousdisease_trajectories(sim_df = out_sird_ft(),
                                        x_axis = "S", y_axis = "D")
  })
