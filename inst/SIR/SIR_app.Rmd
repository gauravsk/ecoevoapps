...
# Simulate model dynamics 
out_seir <- reactive({
  data.frame(run_infectiousdisease_model(time = time_seir(), params = params_seir(),
                                         init = init_seir(), model_type = "SEIR"))
})
...
# Set the initial population sizes
init_sird <- reactive({
  c(S = input$S0_sird, I = input$I0_sird, R = input$S0_sird, D = input$D0_sird)
  })
# Set the parameter values
...
# Simulate model dynamics 
out_sird <- reactive({
  data.frame(run_infectiousdisease_model(time = time_sird(), params = params_sird(),
                                         init = init_sird(), model_type = "SIRD"))
})
...
# Simulate model dynamics 
out_ft <- reactive({
    data.frame(run_infectiousdisease_model(time = time_ft(), params = params_ft(),
                                         init = init_ft(), model_type = "SIR_ft"))
})
...
# Simulate model dynamics 
out_sis_ft <- reactive({
  data.frame(run_infectiousdisease_model(time = time_sis_ft(), params = params_sis_ft(),
                                         init = init_sis_ft(), model_type = "SIS_ft"))
})
...
out_seir_ft <- reactive({
  data.frame(run_infectiousdisease_model(time = time_seir_ft(), params = params_seir_ft(),
                                         init = init_seir_ft(), model_type = "SEIR_ft"))
})
...
out_sird_ft <- reactive({
  data.frame(run_infectiousdisease_model(time = time_sird_ft(), params = params_sird_ft(),
                                         init = init_sird_ft(), model_type = "SIRD_ft"))
})
...
App maintained by Maddi Cowen (mcowen@g.ucla.edu)
