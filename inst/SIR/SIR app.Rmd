...
# Compartmental Infectious Disease Models {.tabset}
All of the following disease models include vital rates (i.e., births/deaths). If the course of the infection is short relative to individual lifespan, the vital rates can be ignored. To run a model without vital rates, set $m = 0$. 
