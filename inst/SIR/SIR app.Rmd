...
\begin{equation}
\frac{dS}{dt} = m*(S + I + R)*(1 - v) - m*S - \beta*S*I\\
\frac{dI}{dt} = \beta*S*I - m*I - \gamma*I\\
\frac{dR}{dt} = \gamma*I - m*R + m*(S + I + R)*v
\end{equation}
...
plots_to_render_SIR_sir_novitals <- reactive({
  wrap_plots(abund_plot_SIR_novitals(), dabund_plot_SIR_novitals(), SIR_2d_plots_novitals(), nrow = 3) 
})
...
\begin{equation}
\frac{dS}{dt} = m*(S + I) - m*S - \beta*S*I + \gamma*I\\
\frac{dI}{dt} = \beta*S*I - m*I - \gamma*I\\
\end{equation}
...
\begin{equation}
\frac{dS}{dt} = m*(S + E + I + R)*(1 - v) - m*S - \beta*S*I\\
\frac{dE}{dt} = \beta*S*I - a*E - m*E\\
\frac{dI}{dt} = a*E - m*I - \gamma*I\\
\frac{dR}{dt} = \gamma*I - m*R + m*(S + E + I + R)*v
\end{equation}
...
plots_to_render_seir <- reactive({
  wrap_plots(abund_plot_seir(), dabund_plot_seir(), SEIR_2d_plots(), nrow = 3) 
})
...
\begin{equation}
\frac{dS}{dt} = m*(S + I + R)*(1 - v) - m*S - \beta*S*I\\
\frac{dI}{dt} = \beta*S*I - m*I - \gamma*I - \mu*I\\
\frac{dR}{dt} = \gamma*I - m*R + m*(S + I + R)*v
\frac{dI}{dt} = \mu*I\\
\end{equation}
...
* $I =$ number of infectious individuals
* $R =$ number of recovered individuals
* $D =$ number of individuals deceased due to infection
* $m =$ death/birth rate
* $beta =$ infection rate
* $gamma =$ recovery rate
...
plots_to_render_sird <- reactive({
  wrap_plots(abund_plot_sird(), dabund_plot_sird(), SIRD_2d_plots(), nrow = 3) 
})
