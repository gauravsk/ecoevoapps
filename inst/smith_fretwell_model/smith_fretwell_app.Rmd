...
offspring_fitness <- run_smith_fretwell_model(Iymin = Iymin, Womax = Womax, Ip = Ip)
...
pp <- reactive({
  run_smith_fretwell_model_sp2(offspring_fitness, Iymin = input$Iymin2, Womax = input$Womax2, Ip = Ip, shapeval = 0.02 * input$Womax2/0.6) + 
