...
***[中文](https://ecoevoapps.shinyapps.io/biotic_resource_competition_ch) |  English | [Turkish](https://ecoevoapps.shinyapps.io/biotic_resource_competition_tr)  ***
...
out <- reactive({
  data.frame(run_biotic_competition_model(time = time(), 
                                                      init = init(), 
                                                      params = params()))
})
